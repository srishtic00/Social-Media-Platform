...
//                         <label className="text-muted">Upload Profile Photo</label>
//                         <input onChange={this.handleChange('photo')} accept='image/*' type='file' className="form-control"  />
//                     </div>
//                     <div className="form-group">
...
class EditProfile extends Component {
  ...
  render() {
    ...
    const photoUrl = id
      ? `http://localhost:5000/user/photo/${id}?${new Date().getTime()}`
      : DefaultProfile;
